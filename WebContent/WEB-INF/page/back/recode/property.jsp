...
<div style="margin-bottom: 10px">
	<select class="col-xs-2 select2" id="buildSelect" style="float: none;height: 35px;" onchange="getdatareflush()">
...
<script type="text/javascript">
		var scripts = [ null, "${contextPath}/static/assets/js/jqGrid/jquery.jqGrid.js", "${contextPath}/static/assets/js/jqGrid/i18n/grid.locale-cn.js", "${contextPath}/static/assets/js/jquery-ui.custom.js","${contextPath}/static/assets/js/select2.js",
