								...
								<div class="widget-body">
									<div class="widget-main">
										...
										<div>
											...
											<input id="linkname" class="form-control" type="text"> 
											<label for="form-field-8">联系人电话号码</label>
											<input id="linkphone" class="form-control" type="text"> 
											<label for="form-field-8">税号</label>
											<input id="dutyparagraph" class="form-control" type="text"> 
										</div>
										<hr />
										<div>
											...
											<input id="banknumber" class="form-control" type="text"> 
										</div>
										<hr />
									</div>
								</div>
		...
		$(".page-content-area").ace_ajax("loadScripts", scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		jQuery(grid_selector).jqGrid({
        			...
        			datatype : "json",
        			height : 450,
        			colNames : ["id","名称", "地址", "联系人姓名","联系人电话号码", "税号", "开户银行","户名","开户银行帐号"],
        			colModel : [ 
        			 {
        				 name:'id',
        				 width : 150,
        		...
        		$("#editInformationButton").bind("click", function() {
        			...
        			if(null == selectedId){
        				...
        				$("#namea").val(jQuery(grid_selector).jqGrid("getRowData",jQuery(grid_selector).jqGrid("getGridParam", "selrow")).namea);
        				$("#address").val(jQuery(grid_selector).jqGrid("getRowData",jQuery(grid_selector).jqGrid("getGridParam", "selrow")).address);
        				$("#linkname").val(jQuery(grid_selector).jqGrid("getRowData",jQuery(grid_selector).jqGrid("getGridParam", "selrow")).linkname);
        				$("#linkphone").val(jQuery(grid_selector).jqGrid("getRowData",jQuery(grid_selector).jqGrid("getGridParam", "selrow")).linkphone);
        				$("#dutyparagraph").val(jQuery(grid_selector).jqGrid("getRowData",jQuery(grid_selector).jqGrid("getGridParam", "selrow")).dutyparagraph);
        				$("#bank").val(jQuery(grid_selector).jqGrid("getRowData",jQuery(grid_selector).jqGrid("getGridParam", "selrow")).bank);
        				$("#bankname").val(jQuery(grid_selector).jqGrid("getRowData",jQuery(grid_selector).jqGrid("getGridParam", "selrow")).bankname);
        				$("#banknumber").val(jQuery(grid_selector).jqGrid("getRowData",jQuery(grid_selector).jqGrid("getGridParam", "selrow")).banknumber);
        			}
        		});
        		...
        		$("#informationForm").on("submit", function(e) {
        			...
        			data.dutyparagraph=$("#dutyparagraph").val();
        			data.bank=$("#bank").val();
