    ...
    <div class="col-xs-12">
        ...
        <div class="row" style="display: none" id="div1">
            <div class="col-xs-4">
                <div class="panel panel-green">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="fa fa-pie-chart"></i>收入支出预算占比图</h3>
                    </div>
            ...
            <div class="col-xs-4">
                <div class="panel panel-green">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="fa fa-pie-chart"></i>收入明细图</h3>
                    </div>
                    <div class="panel-body">
                        <div class="flot-chart">
            ...
            <div class="col-xs-4">
                <div class="panel panel-green">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="fa fa-pie-chart"></i>能源费明细图</h3>
                    </div>
                    <div class="panel-body">
                        <div class="flot-chart">
        ...
        <div class="row" style="display: none" id="div2">
            <div class="col-xs-4">
                <div class="panel panel-green">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="fa fa-pie-chart"></i>办公总务明细图</h3>
                    </div>
                    <div class="panel-body">
                        <div class="flot-chart">
            ...
            <div class="col-xs-4">
                <div class="panel panel-green">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="fa fa-pie-chart"></i>业务外包明细图</h3>
                    </div>
                    <div class="panel-body">
                        <div class="flot-chart">
            ...
            <div class="col-xs-4">
                <div class="panel panel-green">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="fa fa-pie-chart"></i>日常修理明细图</h3>
                    </div>
                    <div class="panel-body">
                        <div class="flot-chart">
