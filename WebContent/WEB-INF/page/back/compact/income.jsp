                                        ...
                                        <div class="widget-main">
                                            <table class="table table-striped table-bordered table-hover"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>固定停车费</td>
                                                    <td id="fixedparking_res" class="budgetclass"></td>
                                                ...
                                                <tr>
                                                    <td>临时停车费</td>
                                                    <td id="tempparking_res" class="budgetclass"></td>
                                                ...
                                                <tr>
                                                    <td colspan="2">水费</td>
                                                    <td id="waterin_res" class="budgetclass"></td>
                                        ...
                                        <div class="widget-main">
                                            <table class="table table-striped table-bordered table-hover"
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2">水费</td>
                                                    <td id="water_res" style="width: 22%" class="budgetclass"></td>
                                                    <td style="width: 22%"><input id="water" type="text"
                                                                                  class="inputc num"></td>
                                                    <td style="width: 22%"><input id="waterps" type="text"
                                                                                  class="inputc ps"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2">电费</td>
                                                    <td id="electricout_res" class="budgetclass"></td>
                                            ...
                                            <table class="table table-striped table-bordered table-hover"
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="stationery_res" style="width: 22%" class="budgetclass"></td>
                                                    <td style="width: 22%"><input id="stationery"
                                                                                  type="text" class="inputc num"></td>
                                                    <td style="width: 22%"><input id="stationeryps"
                                                                                  type="text" class="inputc ps"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2">电话、通信费等</td>
                                                    <td id="communication_res" class="budgetclass"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="drinkwater_res" class="budgetclass"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="doorplate_res" class="budgetclass"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="decorate_res" class="budgetclass"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="cleanser_res" class="budgetclass"></td>
                                                ...
                                                <tr>
                                                    <td colspan="2">绿化费</td>
                                                    <td id="afforestation_res" class="budgetclass"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="ppe_res" class="budgetclass"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="trashcleaning_res" class="budgetclass"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="emergencymaterial_res" class="budgetclass"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="wallwashing_res" class="budgetclass"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="alarmservice_res" class="budgetclass"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="pestcontrol_res" class="budgetclass"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="sewerage_res" class="budgetclass"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="maintenance_res" class="budgetclass"></td>
                                                ...
                                                <tr>
                                                    <td colspan="2">其他</td>
                                                    <td id="office_res" class="budgetclass"></td>
											...
											<table class="table table-striped table-bordered table-hover" style="text-align: center;">
	                                           <tr>
	                                               ...
	                                               <td style="width: 22%" id="security_res" class="budgetclass"></td>
	                                               <td style="width: 22%"><input id="security" type="text" class="inputc num"></td>
	                                               <td style="width: 22%"><input id="securityps" type="text" class="inputc ps"></td>
	                                           </tr>
	                                           <tr>
	                                               <td colspan="2">保洁服务费</td>
	                                               <td style="width: 22%" id="cleansing_res" class="budgetclass"></td>
	                                               <td style="width: 22%"><input id="cleansing" type="text" class="inputc num"></td>
	                                               <td style="width: 22%"><input id="cleansingps" type="text" class="inputc ps"></td>
	                                           </tr>
	                                           <tr>
	                                               <td colspan="2">工程外包</td>
	                                               <td style="width: 22%" id="projectout_res" class="budgetclass"></td>
	                                               <td style="width: 22%"><input id="projectout" type="text" class="inputc num"></td>
	                                               <td style="width: 22%"><input id="projectoutps" type="text" class="inputc ps"></td>
	                                           </tr>
	                                           <tr>
	                                       ...
	                                       <table class="table table-striped table-bordered table-hover" style="text-align: center;">
	                                           <tr>
	                                               ...
	                                               <td style="width: 22%" id="repair_res" class="budgetclass"></td>
	                                               <td style="width: 22%"><input id="repair" type="text" class="inputc num"></td>
	                                               <td style="width: 22%"><input id="repairps" type="text" class="inputc ps"></td>
	                                           </tr>
	                                           <tr>
	                                               <td rowspan="3" style="vertical-align: middle;">设备设施维护</td>
	                                               <td>消防设备设施维护费</td>
	                                               <td style="width: 22%" id="firefighting_res" class="budgetclass"></td>
	                                               <td style="width: 22%"><input id="firefighting" type="text" class="inputc num"></td>
	                                               <td style="width: 22%"><input id="firefightingps" type="text" class="inputc ps"></td>
	                                           </tr>
	                                           <tr>
	                                               <td>工程设备设施维护费</td>
	                                               <td style="width: 22%" id="engineering_res" class="budgetclass"></td>
	                                               <td style="width: 22%"><input id="engineering" type="text" class="inputc num"></td>
	                                               <td style="width: 22%"><input id="engineeringps" type="text" class="inputc ps"></td>
	                                           </tr>
	                                           <tr>
	                                               <td>设备设施检测费</td>
	                                               <td style="width: 22%" id="equipmenttesting_res" class="budgetclass"></td>
	                                               <td style="width: 22%"><input id="equipmenttesting" type="text" class="inputc num"></td>
	                                               <td style="width: 22%"><input id="equipmenttestingps" type="text" class="inputc ps"></td>
	                                           </tr>
	                                           <tr>
	                                               <td rowspan="3" style="vertical-align: middle;">日常修理费用</td>
	                                               <td>材料费</td>
	                                               <td style="width: 22%" id="material_res" class="budgetclass"></td>
	                                               <td style="width: 22%"><input id="material" type="text" class="inputc num"></td>
	                                               <td style="width: 22%"><input id="materialps" type="text" class="inputc ps"></td>
	                                           </tr>
	                                           <tr>
	                                               <td>灭火机</td>
	                                               <td style="width: 22%" id="extinguisher_res" class="budgetclass"></td>
	                                               <td style="width: 22%"><input id="extinguisher" type="text" class="inputc num"></td>
	                                               <td style="width: 22%"><input id="extinguisherps" type="text" class="inputc ps"></td>
	                                           </tr>
	                                           <tr>
	                                               <td>日常维修费</td>
	                                               <td style="width: 22%" id="upkeep_res" class="budgetclass"></td>
	                                               <td style="width: 22%"><input id="upkeep" type="text" class="inputc num"></td>
	                                               <td style="width: 22%"><input id="upkeepps" type="text" class="inputc ps"></td>
	                                           </tr>
	                                           <tr>
                                            ...
                                            <table class="table table-striped table-bordered table-hover"
                                                ...
                                                <tr>
                                                    <td>其他</td>
                                                    <td id="other_res" style="width: 22%" class="budgetclass">4000</td>
                                                    <td style="width: 22%"><input id="other" type="text"
                                                                                  class="inputc num"></td>
                                                    <td style="width: 22%"><input id="otherps" type="text"
                                                                                  class="inputc ps"></td>
                                                </tr>
                                                <tr>
                            ...
                            <div class="col-xs-12 col-sm-12">
                                ...
                                <div class="col-xs-12 col-sm-6" style="text-align: right;">
                                    <div class="btn btn-success btn-lg"
                                        onclick="submitAchievement()">确定</div>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    $(".page-content-area").ace_ajax("loadScripts", scripts, function () {
        ...
        jQuery(function($) {
            ...
            sumnumber();
            //日期初始化
            $('#yearcondition').val(new Date().getFullYear());
            ...
            jQuery(grid_selector).jqGrid({
                ...
                datatype: "json",
                height: 450,
                colNames: ["ID","楼宇代码","楼宇", "年份","月份","毛利润", "收入合计", "成本合计", "能源费合计", "办公总务合计", "业务外包合计", "修理费合计", "其他合计", "操作"],
                colModel: [{
                    name: "id",
                    width: 50,
                    hidden:true,
            ...
            $("#addInformationButton").bind("click", function() {
                ...
                getBudgetByidAndyear($('#lyxx').val(),$('#yearcondition').val());
            });
    ...
    //年度预算回显
    function getBudgetByidAndyear(id,year){
        $.ajax({
            dataType : "json",
    ...
    function setMsgBudgetInfo(data){
        ...
        for(var param in data){
            $('.budgetclass').each(function(i){
                if($(this).attr('id').split('_res')[0] == param){
    ...
    function submitAchievement(){
    	...
    	if($('#month').val() == '' || $('#month').val() == null || parseInt($('#month').val()) > 12 || parseInt($('#month').val()) < 1){
    		$.gritter.add({
                title: '输入错误',
                text: '请输入月份',
                class_name:"gritter-error  gritter-light"
        ...
        params += '"year":"'+$('#yearcondition').val()+'","id":"'+$('#id').val()+'"}';
        $.ajax({
            dataType : "json",
            url : "${contextPath}//recode/achievement/saveOrupdatAchievement",
            type : "post",
            contentType: 'application/json',
            data :params,
            complete : function(xmlRequest) {
    ...
    //编辑数据
    function achievementInfoToview(id,mark){
        $('#id').val(id);
        $.ajax({
            dataType : "json",
            url : "${contextPath}//recode/achievement/getAchievementByCondition?page=1&rows=1&id="+id+"&build="+$("#lyxx").val(),
            type : "post",
            contentType: 'application/json',
            data :null,
            complete : function(xmlRequest) {
    ...
    function budgetinfotoedit(data,mark){
        ...
        $.ajax({
            ...
            complete : function(xmlRequest) {
                console.log(xmlRequest);
                if(xmlRequest.status == 200){
                    var res = JSON.parse(xmlRequest.responseText).rows;
